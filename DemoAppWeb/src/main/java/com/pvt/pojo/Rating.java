...
public class Rating implements Serializable {
    ...
    @JoinColumn(name = "joinuser_id", referencedColumnName = "id")
    @ManyToOne(optional = false)
    private UserJoin joinuserId;
    ...
    public Rating(Integer id, int score) {
        this.id = id;
        this.score = score;
    }
    ...
    public UserJoin getJoinuserId() {
        return joinuserId;
    }

    public void setJoinuserId(UserJoin joinuserId) {
    ...
    public String toString() {
        return "com.pvt.pojo.Rating[ id=" + id + " ]";
    }
